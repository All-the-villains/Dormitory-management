import './CoreDetail.css'
import React, { Component } from 'react'
import {NavLink} from 'react-router-dom'
import {withRouter} from 'react-router-dom'
class CoreDetail extends Component {
    constructor(){
        super();
        this.state={
          stores:[],
    ...
    render() {
        return(<div>
            ...
            <button style={{position:'absolute',left:1380,top:85,height:40,fontSize:25}}
...
export default withRouter(CoreDetail)